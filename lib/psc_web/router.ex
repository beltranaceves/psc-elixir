defmodule PscWeb.Router do
  use PscWeb, :router

  import PscWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {PscWeb.Layouts, :root}
  ...
  if Application.compile_env(:psc, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PscWeb.Telemetry
  ...
  scope "/", PscWeb do
    ...
    live_session :require_authenticated_user,
      ...
      live "/canvas-layouts/:id", CanvasLayoutLive.Editor, :edit
  ...
  scope "/", PscWeb do
    ...
    live_session :current_user,
      on_mount: [{PscWeb.UserAuth, :mount_current_scope}] do
