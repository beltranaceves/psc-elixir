defmodule PscWeb.Layouts do
  ...
  def app(assigns) do
    ~H"""
    <header class="navbar bg-base-200 text-base-content px-4 sm:px-6 lg:px-8">
      <div class="flex-1">
    ...
    <main class="px-4 py-20 sm:px-6 lg:px-8 bg-transparent text-base-content">
