defmodule PscWeb.Components.UI.Form do
  @moduledoc """
  ...
  def form_label(assigns) do
    ...
    ~H"""
    <PscWeb.Components.UI.Label.label
  ...
  def form_message(assigns) do
    ...
    <p
      ...
      class={classes(["text-sm font-medium", (msg || @error) && "text-destructive", @class])}
      {@rest}
    >
      {msg || @message}
    </p>
