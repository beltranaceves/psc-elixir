defmodule PscWeb.Components.UI.Alert do
  @moduledoc """
  ...
  * `:class` - Additional CSS classes to apply to the alert container.
  ...
  def alert(assigns) do
    ...
    <div
      ...
      class={
        classes([
          "relative w-full rounded-lg border border-border p-4 [&>span~*]:pl-7 [&>span+div]:translate-y-[-3px] [&>span]:absolute [&>span]:left-4 [&>span]:top-4",
          @variant_class,
          @class
        ])
      }
