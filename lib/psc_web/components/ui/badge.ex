defmodule PscWeb.Components.UI.Badge do
  @moduledoc """
  ...
  * `:variant` - The visual style of the badge. Available variants:
  ...
  def badge(assigns) do
    ...
    <div
      class={
        classes([
          "inline-flex items-center rounded-full border border-border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-hidden focus:ring-ring/50 focus:ring-[3px]",
          @variant_class,
          @class
        ])
      }
