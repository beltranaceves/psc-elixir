defmodule PscWeb.Components.UI.DropdownMenu do
  @moduledoc """
  ...
  ## Examples:
      ...
      <.dropdown_menu id="user-menu">
        <.dropdown_menu_trigger as={&PscWeb.Components.UI.Button.button/1} variant="outline">
          Open Menu
  ...
  * `:on-open` - Fired when the dropdown menu opens.
  * `:on-close` - Fired when the dropdown menu closes.
  ...
  * `:class` - Additional CSS classes.
  * `:as` - The HTML tag or function component to use for the trigger. Defaults to `"button"`.
  """
  ...
  * `:class` - Additional CSS classes.
  ...
  def dropdown_menu_item(assigns) do
    ...
    <.dynamic
      ...
      class={
        classes([
          "relative flex cursor-default select-none items-center rounded-xs px-2 py-1.5 text-sm outline-hidden focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:mr-2",
          @variant == "destructive" &&
