defmodule PscWeb.Components.UI do
  @moduledoc """
  ...
  ### Server-Client Communication
      ...
      def handle_event("open_dialog", _params, socket) do
        socket = PscWeb.Components.UI.LiveView.send_command(socket, "user-dialog", "open")
        {:noreply, socket}
      end
  ...
  def component do
    quote do
      ...
      import PscWeb.Components.UI.Helpers
  ...
  defmacro __using__(_) do
    quote do
      import PscWeb.Components.UI.Accordion
      import PscWeb.Components.UI.Alert
      import PscWeb.Components.UI.AlertDialog
      import PscWeb.Components.UI.Avatar
      import PscWeb.Components.UI.Badge
      import PscWeb.Components.UI.Breadcrumb
      import PscWeb.Components.UI.Button
      import PscWeb.Components.UI.Card
      import PscWeb.Components.UI.Chart
      import PscWeb.Components.UI.Checkbox
      import PscWeb.Components.UI.Collapsible
      import PscWeb.Components.UI.Dialog
      import PscWeb.Components.UI.DropdownMenu
      import PscWeb.Components.UI.Form
      import PscWeb.Components.UI.Helpers
      import PscWeb.Components.UI.HoverCard
      import PscWeb.Components.UI.Icon
      import PscWeb.Components.UI.Input
      import PscWeb.Components.UI.Label
      import PscWeb.Components.UI.Menu
      import PscWeb.Components.UI.Pagination
      import PscWeb.Components.UI.Popover
      import PscWeb.Components.UI.Progress
      import PscWeb.Components.UI.RadioGroup
      import PscWeb.Components.UI.ScrollArea
      import PscWeb.Components.UI.Select
      import PscWeb.Components.UI.Separator
      import PscWeb.Components.UI.Sheet
      import PscWeb.Components.UI.Sidebar
      import PscWeb.Components.UI.Skeleton
      import PscWeb.Components.UI.Slider
      import PscWeb.Components.UI.Switch
      import PscWeb.Components.UI.Table
      import PscWeb.Components.UI.Tabs
      import PscWeb.Components.UI.Textarea
      import PscWeb.Components.UI.Toast
      import PscWeb.Components.UI.Toggle
      import PscWeb.Components.UI.ToggleGroup
      import PscWeb.Components.UI.Tooltip
    end
  end
end
